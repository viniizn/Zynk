<div class="flex-1 p-3 -ml-5 sm:-ml-3">
    ...
    <p class="text-sm sm:text-base text-gray-700 dark:text-gray-100 leading-relaxed 
        sm:break-words max-w-full sm:max-w-[500px] mt-2 mb-5 line-clamp-2">{{ $post->description }}</p>
